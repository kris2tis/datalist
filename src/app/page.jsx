            ...
            <div className="flex items-center gap-3 mb-3 ">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-slate-500">
                  مدیر بازاریابی، شرکت تکفا
                </div>
              </div>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-300 text-right leading-relaxed">
              دیتالیست به ما کمک کرد تا داده‌های پراکنده خود را یکپارچه کنی.
              گزارش‌های تحلیلی آنها دیدگاه ما را نسبت به مشتریان کاملاً تغییر
              داد.
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-5 rounded-xl shadow-sm border border-slate-100 dark:border-gray-700">
            <div className="flex items-center gap-3 mb-3 ">
              ...
              <div className="text-right">
                ...
                <div className="text-xs text-slate-500">
                  مدیر عامل، استارتاپ نوا
                </div>
              </div>
            </div>
            <p className="text-sm text-slate-600 dark:text-slate-300 text-right leading-relaxed">
              امنیت داده‌ها برای ما اولویت اول بود و دیتالیست با استانداردهای
              بانکی خود خیال ما را راحت کرد. پشتیبانی عالی و حرفه‌ای.
            </p>
          </div>
        </div>
      </section>
