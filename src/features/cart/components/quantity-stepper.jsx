...
export default function QuantityStepper({ currentValue, data }) {
  ...
  return (
    <div class="flex items-center bg-gray-50 dark:bg-gray-800/80 border border-gray-200 dark:border-gray-700 rounded-lg p-0.5 h-8">
      <button
        onClick={addProductFromCart}
        class="w-7 h-full flex items-center justify-center text-primary dark:text-blue-400 
      ...
      <input
        class="w-8 text-center text-sm font-semibold bg-transparent border-none 
      ...
      <button
        ...
        class="w-7 h-full flex items-center justify-center text-gray-400 dark:text-gray-500 
